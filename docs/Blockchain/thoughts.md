...
71. 不看且放弃的几个领域: 隐私、音乐 NFT、AI、比特币相关、小游戏、硬件.

72. 三权分立, 开发立法, DAO裁决, 网络行政. 但是团队通过代币分配和主动权绑架了权力, 上演多数人暴政. 只有创始人跑路了的比特币杜绝了这个问题, 削弱了开发团队的能力.

73. [比特币永远滴神](/img/thoughts/bitcoin.jpg).

74. 从社会的发展上来看, MEV(neo-liberalism)和DAO(美国社会)的治理问题无法解决.

75. NFT 的唯一性不存在于元数据和智能合约, 而是存在于智能合约的 ID 上或者说独特的区块空间.

76. 目前 Web3 只有基础设施, 没有任何应用.

77. Crypto 该做的是 target 更多技术宅, 目前别奢望 mass adoption. 毕竟是从黑客开始的.

78. 基础设施 => 应用? => 基础设施? => 应用?

79. zk 无法完全解决问题, 一旦问题不被完全解决, 那么就等于没有被解决.
...
86. 看山是山 (这个东西真好玩, 好多知识, 颠覆金融), 看山不是山 (体量太小了, 总归要走向中心化, 性能垃圾, 骗局, 迟早失败), 看山是山 (求索的过程才重要, 拥抱泡沫, 寻找价值). 没懂知道自己不懂, 没懂感觉懂了, 真的懂了.

87. 1. 知道方向, 2. 知道信息在哪里, 3. 知道信息的知识.

88. 任何事情都讲究新手福利期 (最有想象力和最能成长和摸索清楚事情怎么做的阶段), 要习惯从零到一.

89. 我的 bookmark 里有 1000 篇文章, 每个研究员都需要有一个图书馆.

90. TWAP 完全展现了区块链是一个时钟.

91. 反人性的活动 (跑步), 可以通过代币来激励.

92. PoS 让随机性下降了, 需要防范一些更多层面的攻击.

93. 链上验证 === on-chain 哈哈...

94. sovereign rollup 不如 pos 和 secured rollup, 无法 onchain 验证某些事情, 性能瓶颈可能在 settlemenmt layer.
